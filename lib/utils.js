const debug = require('debug')('W2:Studio:utils');
...
function basicRender(name, data, req, res) {
    ...
    resource.baseUrl = req.app.get('w2:baseUrl');

    // Common for all pages (layout)
    resource.link('home', RoutesInfo.expand('w2:home'));
    resource.link('search', RoutesInfo.expand('w2:search'));
