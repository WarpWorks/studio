...
module.exports = (subPath, baseUrl) => {
	...
	routesInfo.route('w2:plugins', '/plugins')
		.get(controllers.plugin.list);
	...
	routesInfo.route('w2:plugin-Function', '/pluginFunction')
		.post(controllers.plugin.pluginFunction);
