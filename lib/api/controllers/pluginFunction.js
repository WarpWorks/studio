...
pluginContainer.CreateOpenApi = function(domainName){
	...
	Domain.prototype.getOpenApi =  function(){
		...
		openApiSpec = new createApiSpec('35.189.101.177:8080','/content/REST/'+this.name);
	...
	Entity.prototype.entityEndpoint = function(array,innerEntity){
		...
		var parameters = []
		parameters.push({"in":"body","name":"body",
	...
	Entity.prototype.entityInstanceEndpoint = function(){	
			...
			"consumes":["application/json"],
			"produces":["application/json"],
			"parameters":[{"in":"path","name":ent.name+"_id","required":true,type:typeof(ent.id),"description": ent.name+"_id that needs to be updated "},
