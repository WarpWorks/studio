...
class Base {
    ...
    getInstancePath(persistence, instance) {
        return Promise.resolve()
            .then(() => {
                const parentEntity = this.getDomain().getParentEntityByParentBaseClassName(instance);
                if (parentEntity) {
                    return parentEntity.getInstance(persistence, instance.parentID)
                        .then((parentInstance) => parentEntity.getInstancePath(persistence, parentInstance));
                }
    ...
    getInstance(persistence, id) {
        return persistence.findOne(this.name, { _id: id }, true);
    }
