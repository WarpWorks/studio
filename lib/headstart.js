...
class HeadStart {
    ...
    getDomainByName(domainName) {
        ...
        return this.createDomainFromJSON(domainJson);
    }
        ...
        switch (type) {
            ...
            case ComplexTypes.Panel:
                ...
                for (i in jsonData.relationshipPanelItems) {
                    newRelationshipPanelItem = this.createInstanceFromJSON(jsonData.relationshipPanelItems[i], ComplexTypes.RelationshipPanelItem, newPanel);
